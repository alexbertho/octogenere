...
Ce rapport décrit l'implémentation de la branche \code{dev} au commit \code{c779781}, datée du 11 septembre 2026. Les intentions de conception sont distinguées des mécanismes effectivement présents. Les diagrammes représentent cette version du code ; les évolutions proposées sont annoncées comme telles.
