...
The OctoGenere project automatically evaluates untrusted third-party software projects. My responsibility during the group poject was the security subsystem which takes care of isolating any code that is executed, and making sure the LLM treats the source code as data and not as instructions. Both live in the \texttt{fr.octogenere.security} package, that is divided into the \texttt{sandbox} and \texttt{injection} sub-packages.
